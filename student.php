           ...
           <h2>List of Students</h2>
                <?php
                    if(isset($_POST['submit'])){
                        $q = mysqli_query($db, "SELECT `first`,`last`,`username`,`indexno`,`email`,`telno` FROM `student` WHERE `username` like '%$_POST[search]%'");
                        ...
                        $res= mysqli_query($db,"SELECT `first`,`last`,`username`,`indexno`,`email`,`telno` FROM `student` ORDER BY `student`.`first` ASC;");
